...
const StatusWidget = ({ status }:{status:string}) => {
  switch (status) {
    case CommodityStatus.draft:
      return (
        <div className={`inline-flex items-center py-1 px-3 rounded-full bg-gray-100`}>
    ...
    case CommodityStatus.giving:
      return (
        <div className={`inline-flex items-center py-1 px-3 rounded-full bg-orange-100`}>
    ...
    case CommodityStatus.receiving:
      return (
        <div className={`inline-flex items-center py-1 px-3 rounded-full bg-green-100`}>
